...
/*=========================== CHASSIS = RUNKO ====================================================*/
      ...
      b2PolygonShape chassis;
      chassis.SetAsBox( (100.0f/2.0f)/SCALE, (36.33f/2.0f)/SCALE );//Sprite: width=100px, height=36.33px
...
/*=========================== WHEELS ==============================================================*/
      ...
      circle.m_radius = 11.66f/SCALE;//WheelSprite: half-width=11.66px
